        ...
        @foreach ($locationData as $location)
          <div class="place-card mb-3">
            <div class="mb-4">
              ...
              <div class="overflow-hidden rounded h-32">
            ...
            <div class="flex gap-2">
              <button onclick="changeMap('{{ $location->google_map }}')"
                class="bg-black text-white w-full h-12 flex hover:cursor-pointer items-center justify-center rounded-md hover:bg-gray-800 transition">
                Product in store
              </button>
              @if ($location->phone)
