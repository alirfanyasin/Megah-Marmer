...
@section('content')
  ...
  <section class="relative h-[90vh] bg-cover bg-center flex items-center" id="textured"
    style="background-image: linear-gradient(to bottom right, rgba(40,40,40,.75), rgba(0,0,0,.65)), url('https://www.thewoodveneerhub.co.nz/cdn/shop/articles/wvh-acoustic-slat-wood-wall-panels-natural-oak-acoustic-slat-wood-wall-panels-42817455522106_81a2953e-6bbf-4b48-a95e-02a4acdd4362_800x800.jpg?v=1701906100');">
