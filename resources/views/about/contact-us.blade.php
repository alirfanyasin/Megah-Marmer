    ...
    <div class="lg:col-span-2 bg-white flex items-center py-16 px-6 sm:px-10 lg:px-16">
      <div class="w-full max-w-lg mx-auto">
        ...
        <form class="space-y-5">
          ...
          <div>
            <label for="projectType" class="block text-xs font-medium text-gray-700 mb-2 uppercase tracking-wider">Project
              Type</label>
          ...
          <button type="submit"
            class="w-full bg-stone-900 text-white py-4 px-8 rounded-none hover:bg-stone-800 transition-all duration-300 text-base font-medium uppercase tracking-wider">
            Submit Inquiry
          </button>
        </form>
      </div>
